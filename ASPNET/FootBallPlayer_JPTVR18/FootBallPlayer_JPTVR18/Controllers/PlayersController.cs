...
namespace FootBallPlayer_JPTVR18.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Age,Position,Photo,PhotoType,TeamId")] Player player, HttpPostedFileBase
        Image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Age,Position,Photo,PhotoType,TeamId")] Player player, HttpPostedFileBase
        Image)
        {
            if (ModelState.IsValid)
            {
